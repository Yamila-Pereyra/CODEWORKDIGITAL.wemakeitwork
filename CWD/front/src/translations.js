    ...
    es: {
        ...
        contactPage: {
            ...
            form: {
                ...
                error: "No pudimos completar el envío. Intenta nuevamente.",
                successTitle: "¡Gracias! Recibimos tu mensaje.",
                successDetail: "Revisaremos la información que nos compartiste. Revisá tu casilla de email: te responderemos por allí a la brevedad.",
                optional: "Opcional",
                messages: {
                    configuration: "El formulario no está disponible en este entorno.",
                    invalidData: "Revisá los datos ingresados e intentalo nuevamente.",
                    internalError: "No pudimos completar el envío. Intenta nuevamente.",
                    network: "No fue posible contactar el servicio. Intenta nuevamente.",
                    requestTooLarge: "El mensaje es demasiado extenso. Revisalo e intenta nuevamente.",
                    retryConflict: "No pudimos completar el reintento. Volvé a verificar e intentá nuevamente.",
                    serviceUnavailable: "El servicio no está disponible en este momento. Intenta nuevamente más tarde.",
                    verificationExpired: "La verificación de seguridad venció. Para enviar tu consulta, actualizá la página y completá nuevamente la verificación.",
                    verificationFailed: "No pudimos validar la verificación. Intenta nuevamente.",
                    verificationRequired: "Completá la verificación antes de enviar.",
                    verificationUnavailable: "La verificación no está disponible en este momento. Intenta nuevamente más tarde.",
                },
                errors: {
                    requiredName: "Ingresá tu nombre.",
                    nameTooLong: "Tu nombre no puede superar los 120 caracteres.",
                    requiredEmail: "Ingresá tu email.",
                    invalidEmail: "Ingresá un email válido.",
                    emailTooLong: "Tu email no puede superar los 254 caracteres.",
                    invalidWhatsApp: "Ingresá un número de WhatsApp válido.",
                    phoneTooLong: "Tu WhatsApp no puede superar los 40 caracteres.",
                    companyProjectTooLong: "Empresa / Proyecto no puede superar los 160 caracteres.",
                    requiredMessage: "Escribí un mensaje.",
                    messageTooLong: "Tu mensaje no puede superar los 4000 caracteres.",
                },
            },
        },
        serviciosPage: {
            ...
            editorial: {
                eyebrow: "NUESTRO CRITERIO",
                title: "La solución no se mide por lo que se ve",
                intro: "A veces, una landing sólo necesita recibir una consulta de manera fiable. Otras veces, ese mismo formulario inicia un proceso que requiere validación, persistencia, integración, seguimiento, permisos y trazabilidad.",
                contrast: "La interfaz puede parecer similar. La arquitectura no lo es.",
                analysis: "Antes de decidir qué construir, analizamos el proceso de negocio que comienza detrás de cada interacción: qué información circula, quién debe intervenir, qué decisiones deben tomarse, qué integraciones son necesarias y qué nivel de trazabilidad requiere el sistema.",
                sizing: "Por eso no dimensionamos la infraestructura por la cantidad de campos, sino por lo que debe suceder después de que una persona presiona «Enviar».",
                complexity: "No agregamos complejidad para demostrar capacidad técnica. Tampoco consideramos resuelto un proceso importante sólo porque los datos hayan sido enviados.",
                closing: "Diseñamos cada solución desde el proceso hacia la tecnología: ni más ni menos.",
            },
            cta: {
    ...
    en: {
        ...
        contactPage: {
            ...
            form: {
                ...
                error: "We could not complete the submission. Please try again.",
                successTitle: "Thank you! We received your message.",
                successDetail: "We’ll review the information you shared. Keep an eye on your inbox—we’ll get back to you there shortly.",
                optional: "Optional",
                messages: {
                    configuration: "This form is not available in the current environment.",
                    invalidData: "Please review the information and try again.",
                    internalError: "We could not complete the submission. Please try again.",
                    network: "We could not reach the service. Please try again.",
                    requestTooLarge: "Your message is too long. Please review it and try again.",
                    retryConflict: "We could not complete the retry. Please verify again and try once more.",
                    serviceUnavailable: "The service is not available right now. Please try again later.",
                    verificationExpired: "The security verification expired. To send your enquiry, refresh the page and complete the verification again.",
                    verificationFailed: "We could not validate the verification. Please try again.",
                    verificationRequired: "Complete the verification before sending.",
                    verificationUnavailable: "Verification is not available right now. Please try again later.",
                },
                errors: {
                    requiredName: "Enter your name.",
                    nameTooLong: "Your name cannot exceed 120 characters.",
                    ...
                    phoneTooLong: "Your WhatsApp number cannot exceed 40 characters.",
                    companyProjectTooLong: "Company / Project cannot exceed 160 characters.",
        ...
        serviciosPage: {
            ...
            editorial: {
                eyebrow: "OUR APPROACH",
                title: "A solution is not measured by what can be seen",
                intro: "Sometimes, a landing page only needs to receive an enquiry reliably. At other times, the same form starts a process that requires validation, persistence, integration, follow-up, permissions and traceability.",
                contrast: "The interface may look similar. The architecture is not.",
                analysis: "Before deciding what to build, we analyse the business process that begins behind each interaction: what information moves through it, who needs to be involved, which decisions must be made, what integrations are required and how much traceability the system needs.",
                sizing: "That is why we do not size infrastructure by the number of fields, but by what must happen after someone presses “Send”.",
                complexity: "We do not add complexity to demonstrate technical capability. Nor do we consider an important process solved simply because the data has been submitted.",
                closing: "We design each solution from the process to the technology: no more, no less.",
            },
            cta: {
    ...
    it: {
        ...
        contactPage: {
            ...
            form: {
                ...
                sending: "Invio del messaggio...",
                error: "Non siamo riusciti a completare l'invio. Riprova.",
                successTitle: "Grazie! Abbiamo ricevuto il tuo messaggio.",
                successDetail: "Esamineremo le informazioni che ci hai inviato. Controlla la tua casella email: ti risponderemo lì al più presto.",
                optional: "Facoltativo",
                messages: {
                    configuration: "Il modulo non è disponibile in questo ambiente.",
                    invalidData: "Controlla i dati inseriti e riprova.",
                    internalError: "Non siamo riusciti a completare l'invio. Riprova.",
                    network: "Non è stato possibile contattare il servizio. Riprova.",
                    requestTooLarge: "Il messaggio è troppo lungo. Controllalo e riprova.",
                    retryConflict: "Non siamo riusciti a completare il nuovo tentativo. Verifica di nuovo e riprova.",
                    serviceUnavailable: "Il servizio non è disponibile in questo momento. Riprova più tardi.",
                    verificationExpired: "La verifica di sicurezza è scaduta. Per inviare la tua richiesta, aggiorna la pagina e completa nuovamente la verifica.",
                    verificationFailed: "Non siamo riusciti a convalidare la verifica. Riprova.",
                    verificationRequired: "Completa la verifica prima di inviare.",
                    verificationUnavailable: "La verifica non è disponibile in questo momento. Riprova più tardi.",
                },
                errors: {
                    requiredName: "Inserisci il tuo nome.",
                    nameTooLong: "Il tuo nome non può superare i 120 caratteri.",
                    requiredEmail: "Inserisci la tua email.",
                    invalidEmail: "Inserisci un indirizzo email valido.",
                    emailTooLong: "La tua email non può superare i 254 caratteri.",
                    invalidWhatsApp: "Inserisci un numero WhatsApp valido.",
                    phoneTooLong: "Il tuo numero WhatsApp non può superare i 40 caratteri.",
                    companyProjectTooLong: "Azienda / Progetto non può superare i 160 caratteri.",
                    requiredMessage: "Scrivi un messaggio.",
                    messageTooLong: "Il tuo messaggio non può superare i 4000 caratteri.",
                },
            },
        },
        serviciosPage: {
            ...
            editorial: {
                eyebrow: "IL NOSTRO APPROCCIO",
                title: "Una soluzione non si misura da ciò che si vede",
                intro: "A volte, una landing page deve soltanto ricevere una richiesta in modo affidabile. Altre volte, lo stesso modulo avvia un processo che richiede validazione, persistenza, integrazione, monitoraggio, autorizzazioni e tracciabilità.",
                contrast: "L’interfaccia può sembrare simile. L’architettura no.",
                analysis: "Prima di decidere cosa costruire, analizziamo il processo di business che inizia dietro ogni interazione: quali informazioni circolano, chi deve intervenire, quali decisioni devono essere prese, quali integrazioni sono necessarie e quale livello di tracciabilità richiede il sistema.",
                sizing: "Per questo non dimensioniamo l’infrastruttura in base al numero di campi, ma in base a ciò che deve accadere dopo che una persona preme «Invia».",
                complexity: "Non aggiungiamo complessità per dimostrare capacità tecnica. E non consideriamo risolto un processo importante solo perché i dati sono stati inviati.",
                closing: "Progettiamo ogni soluzione partendo dal processo e arrivando alla tecnologia: né più né meno.",
            },
            cta: {
